...
Goal The goal of this projects is to use data collected from various wearable devices on the belt, forearm, arm, and dumbbell of six participants.

Participants were asked to perform barbell lifts correctly and incorrectly in five different ways.

Data Sources Training, <https://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv> Testing, <https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv> Project data source, <http://groupware.les.inf.puc-rio.br/har>
