...
Resampling results across tuning parameters:
  ...
  mtry  Accuracy   Kappa    
     2  0.2843416  0.0000000
    97  0.9218902  0.9010683
  4749  0.9806360  0.9755070

Accuracy was used to select the optimal model using the largest value.
The final value used for the model was mtry = 4749.
```

```{r}
# Tune results, 000010.png with printout
plot(rf_model)
